...
namespace Hilite
{
    ...
    {
        internal static string NullString(string actual) 
        {
            return actual ?? string.Empty;
        }

        internal static string EmptyString(string actual, string mask) 
        {
            return NullString(actual).Length == 0 ? mask : actual;
        }
    }
}
